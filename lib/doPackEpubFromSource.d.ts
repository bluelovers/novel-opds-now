...
export declare function _doPackEpubFromSource(siteID: EnumNovelSiteList, novelID: string | number): Bluebird<import("cross-spawn-extra").SpawnASyncReturnsPromise<Buffer>>;
