...
exports.setIPFSToCache = exports.getIPFSFromCache = exports.useIPFSFromCache = exports.getIPFS = exports._info = exports._useIPFS = exports.searchIpfs = exports.useIPFS = void 0;
const tslib_1 = require("tslib");
require("../util/processHandle");
const processExit_1 = tslib_1.__importDefault(require("../util/processExit"));
...
const computer_info_1 = tslib_1.__importDefault(require("computer-info"));
...
const cors_1 = tslib_1.__importDefault(require("ipfs-util-lib/lib/ipfs/config/cors"));
...
function useIPFS(options) {
    return bluebird_1.default.resolve().then(() => {
        ...
        if (_timeout || _failed_count > 5) {
            logger_1.default.error(`[IPFS]`, `IPFS 無法啟動，請手動重新啟動伺服器`);
    ...
    return bluebird_1.default
        ...
        if (!ipfsd.started) {
            ...
            if (!disposable && await (0, repoExists_1.repoExists)(ipfsd.path)) {
                let bool = await (0, fs_extra_1.pathExists)(back_up_identity_1.FILE_IDENTITY);
                if (!oldExists && bool) {
                    ...
                    await (0, fs_extra_1.readJSON)((0, path_1.join)(ipfsd.path, 'config'))
                        ...
                        return (0, repo_config_1.writeRepoConfig)(ipfsd.path, config);
                    });
                }
                else if (!bool) {
