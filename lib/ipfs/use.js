    ...
    return bluebird_1.default.resolve().then(() => {
        ...
        return _waiting
            ...
            return (0, index_1.pubsubSubscribe)(ipfs)
                ...
                (0, bluebird_allsettled_1.allSettled)([
                    (0, peer_1.connectPeers)(ipfs, `12D3KooWEJeVsMMPWdnxHFMaU5uqggtULrF3gHxu15uW5scP8DTJ`, me, 30 * 60 * 1000),
                    (0, peer_1.connectPeers)(ipfs, `12D3KooWQzajFygNXqrpFDdEc3WCVLAYh29LNWW9LYupefuye2LJ`, me, 30 * 60 * 1000),
                ])
...
function _useIPFS(options) {
    ...
    return bluebird_1.default
        ...
        if (!ipfsd.started) {
            ...
            if (!oldExists && !disposable && await (0, repoExists_1.repoExists)(ipfsd.path)) {
                if (await (0, fs_extra_1.pathExists)((0, path_1.join)(const_1.__root, 'test', '.identity.json'))) {
        ...
        if (!ipfsd.started) {
            ...
            await ipfsd.start()
                .catch(async (e) => {
                e && logger_1.default.warn(String(e));
        ...
        const stop = (done) => {
            ...
            try {
                ...
                peer_1.peerAbortController.clear();
            }
            catch (e) {
            }
            return Promise.all([
