        ...
        return bluebird_1.default
            ...
            let list = await getIpfsGatewayList(ipfs)
                ...
                (0, ipfs_server_list_1.filterList)('GatewayDomain')
                    .forEach((gateway) => {
                    try {
                        list.push((0, ipfs_subdomain_1.default)(data.hash, gateway) + data.path);
                    }
                    catch (e) {
                    }
                });
            ...
            !(options === null || options === void 0 ? void 0 : options.hidden) && logger_1.default.debug(`[IPFS]`, `pokeAll:start`, list.length, cid, filename);
