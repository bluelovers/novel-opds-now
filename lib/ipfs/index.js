...
exports.putEpubFileInfo = exports.getEpubFileInfo = exports.SymNovelID = exports.SymSiteID = void 0;
...
exports.SymSiteID = Symbol.for('siteID');
exports.SymNovelID = Symbol.for('novelID');
        ...
        siteID.forEach(siteID => {
            novelID.forEach(novelID => {
                ...
                (0, fetch_1.default)(url.href, {
                    ...
                    .then(_resolve)
                    .then(v => {
                    v[exports.SymSiteID] = siteID;
                    v[exports.SymNovelID] = novelID;
                    return v;
                })
                    .catch(_reject);
            });
...
function putEpubFileInfo(siteID, novelID, data) {
    return (0, db_api_1.putFileRecord)({
        ...
        .tapCatch(e => {
        logger_1.consoleLogger.error(`putEpubFileInfo`, `上傳資料時發生錯誤`, e);
    });
}
