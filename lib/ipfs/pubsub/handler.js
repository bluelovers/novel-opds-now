        ...
        if (json) {
            ...
            if (msg.topicIDs.includes(index_1.EPUB_TOPIC)) {
                if (typeof json.peerID !== 'undefined' && json.type && msg.from.toString() === json.peerID.toString()) {
                    logger_1.default.info(`[IPFS]`, `peer:online`, me.id === msg.from ? 'You!' : json.peerID, msg.topicIDs, `${types_1.EnumPubSubHello[json.type]}:${json.type}`, (_a = json.peers) === null || _a === void 0 ? void 0 : _a.length);
