...
async function daemonFactory(disposable, options) {
    ...
    const myFactory = (0, ipfsd_ctl_1.createFactory)({
        ipfsHttpModule: await Promise.resolve().then(() => tslib_1.__importStar(require('ipfs-http-client'))),
        ipfsBin: (0, ipfs_env_1.default)().IPFS_GO_EXEC || await Promise.resolve().then(() => tslib_1.__importStar(require('go-ipfs'))).then(m => m.path()),
        ipfsOptions: {
            EXPERIMENTAL: {
                ipnsPubsub: true,
        ...
        repoAutoMigrate: true,
        args: [
            ...((_c = (_b = options === null || options === void 0 ? void 0 : options.factoryOptions) === null || _b === void 0 ? void 0 : _b.args) !== null && _c !== void 0 ? _c : []),
            '--enable-gc',
        ]
    });
