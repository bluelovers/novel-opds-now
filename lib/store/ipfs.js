...
function getIPFSEpubFile(_siteID, _novelID, options) {
    ...
    return (0, index_2.getEpubFileInfo)(siteID, novelID)
        ...
        .then(async (data) => {
        logger_1.default.debug(`驗證緩存檔案...`, siteID, novelID, (0, lodash_1.omit)(data, ['base64']), (0, moment_1.default)(data.timestamp).locale('zh-tw').fromNow());
        if ((0, checkData_1.default)(data)) {
            logger_1.default.debug(`下載緩存檔案...`, siteID, novelID, data.href);
            let buf = await (0, downloadEpubRace_1.downloadEpubRace)(data.href, void 0, (query.debug || query.force) ? 5 * 60 * 1000 : void 0)
                .catch(e => {
                logger_1.default.debug(`下載緩存檔案失敗...`, siteID, novelID, data.href, String(e));
                return null;
            });
            if (buf === null || buf === void 0 ? void 0 : buf.length) {
                logger_1.default.debug(`分析緩存檔案...`, siteID, novelID, data.href);
