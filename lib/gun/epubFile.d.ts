...
export declare function allGunEpubFile(siteID: ITSValueOrArray<string>, novel_id: ITSValueOrArray<string | number>): any[];
export declare function promiseGunEpubFile<T = IGunEpubNode>(siteID: string | string[], novel_id: string | string[]): Bluebird<any>[];
