...
{
	console.info(`如果使用以下位址依然不能連上伺服器的話，請利用網路搜尋如何查詢自己的電腦IP，或利用 ${terminalLink(`share-localhost`, `https://www.npmjs.com/package/share-localhost`)} 這類工具來讓外部網路可以讀取自己內部網路的IP`);
