...
function doPackEpubFromSource(siteID, novelID) {
    ...
    return bluebird_1.default.resolve()
        ...
        if (_catch.has(key)) {
            ...
            if (p.isPending()) {
                logger_1.default.warn(`此小說的打包任務仍在執行中，請稍後再請求檔案...`, siteID, novelID);
                return p;
            }
            else if (p.isFulfilled()) {
                return p;
            }
            await p.catch(e => logger_1.default.warn(`上次的打包任務失敗...`, siteID, novelID, e));
        }
        ...
        .tapCatch(e => {
        logger_1.default.error(`打包時發生錯誤...`, siteID, novelID, e);
    })
        .finally(() => _catch.delete(key));
}
exports.doPackEpubFromSource = doPackEpubFromSource;
function _doPackEpubFromSource(siteID, novelID) {
    logger_1.default.yellow.info(`從原始來源網站抓取打包小說中...`, siteID, novelID);
    return bluebird_1.default.resolve((0, cross_spawn_extra_1.async)('node', [
        '--experimental-worker',
